...
<doc-anchor-target id="iphone-установка-vpn-vless-на-iphone" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#iphone-установка-vpn-vless-на-iphone">#</doc-anchor-trigger>
    </h1>
</doc-anchor-target>
...
<p>При первом подключении система IOS попросит разрешение для v2RayTun — подтвердите его</p>
