...
<doc-anchor-target id="penguin-установка-vpn-vless-на-linux" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#penguin-установка-vpn-vless-на-linux">#</doc-anchor-trigger>
    </h1>
</doc-anchor-target>
...
<doc-anchor-target id="3-установить-приложение-hiddify">
    <h4>
        <doc-anchor-trigger class="header-anchor-trigger" to="#3-установить-приложение-hiddify">#</doc-anchor-trigger>
        <span>3. <strong>Установить приложение Hiddify</strong></span>
    </h4>
</doc-anchor-target>
<p>
<div class="mb-6 px-5 py-4 flex justify-between relative border border-base-border hover:border-base-border-hover rounded transition-colors duration-150">
    ...
    <div class="flex items-center text-xs text-gray-400 dark:text-dark-400">
        <span>https://github.com/hiddify/hiddify-app/releases</span>
    </div>
    <a href="https://github.com/hiddify/hiddify-app/releases" target="_blank" class="absolute block inset-0"></a>
</div>
</p>
<doc-anchor-target id="4-открыть-приложение-hiddify">
    <h4>
        <doc-anchor-trigger class="header-anchor-trigger" to="#4-открыть-приложение-hiddify">#</doc-anchor-trigger>
        <span>4. <strong>Открыть приложение Hiddify</strong></span>
    </h4>
</doc-anchor-target>
...
<p>Нажмите на кнопку «Новый профиль»</p>
<p><figure class="content-center">
    <img src="https://okvpn.wiki/static/hiddify/1.png" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="600" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
<doc-anchor-target id="6-импортировать-ключ">
    <h4>
        <doc-anchor-trigger class="header-anchor-trigger" to="#6-импортировать-ключ">#</doc-anchor-trigger>
        <span>6. <strong>Импортировать ключ</strong></span>
    </h4>
</doc-anchor-target>
<p>Нажмите на кнопку «Добавить из буфера обмена», ключ вставится автоматически</p>
<p><figure class="content-center">
    <img src="https://okvpn.wiki/static/hiddify/2.png" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="600" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
...
<p>Вы успешно вставили ключ. Нажмите на бело-синюю кнопку в центре, чтобы включить VPN. Чтобы отключить — нажмите ещё раз</p>
<p><figure class="content-center">
    <img src="https://okvpn.wiki/static/hiddify/3.png" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="600" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
