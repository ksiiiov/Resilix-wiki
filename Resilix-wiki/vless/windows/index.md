...
<doc-anchor-target id="desktop_computer-установка-vpn-vless-на-windows" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#desktop_computer-установка-vpn-vless-на-windows">#</doc-anchor-trigger>
    </h1>
</doc-anchor-target>
...
<div class="mb-6 px-5 py-4 flex justify-between relative border border-base-border hover:border-base-border-hover rounded transition-colors duration-150">
    ...
    <div class="flex items-center text-xs text-gray-400 dark:text-dark-400">
        <span>https://disk.360.yandex.ru/d/_DFhR9ch5RMkQg</span>
    </div>
    <a href="https://disk.360.yandex.ru/d/_DFhR9ch5RMkQg" target="_blank" class="absolute block inset-0"></a>
</div>
</p>
