...
<doc-anchor-target id="robot_face-установка-vpn-vless-на-android" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#robot_face-установка-vpn-vless-на-android">#</doc-anchor-trigger>
    </h1>
</doc-anchor-target>
...
<doc-anchor-target id="3-установить-приложение-v2raytun">
    <h4>
        <doc-anchor-trigger class="header-anchor-trigger" to="#3-установить-приложение-v2raytun">#</doc-anchor-trigger>
...
<div class="mb-6 px-5 py-4 flex justify-between relative border border-base-border hover:border-base-border-hover rounded transition-colors duration-150">
    ...
    <div class="flex items-center text-xs text-gray-400 dark:text-dark-400">
        <span>https://play.google.com/store/apps/details?id=com.v2raytun.android</span>
    </div>
    <a href="https://play.google.com/store/apps/details?id=com.v2raytun.android" target="_blank" class="absolute block inset-0"></a>
</div>
</p>
