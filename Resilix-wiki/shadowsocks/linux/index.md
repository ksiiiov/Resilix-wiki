...
<doc-anchor-target id="penguin-установка-vpn-shadowsocks-на-linux" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#penguin-установка-vpn-shadowsocks-на-linux">#</doc-anchor-trigger>
    </h1>
</doc-anchor-target>
...
<div class="mb-6 px-5 py-4 flex justify-between relative border border-base-border hover:border-base-border-hover rounded transition-colors duration-150">
    <div class="flex items-center text-base-500">
        ...
        <span class="inline-block font-medium ml-2">Linux</span>
    </div>
    <div class="flex items-center text-xs text-gray-400 dark:text-dark-400">
        <span>https://support.google.com/outline/answer/15331527</span>
    </div>
    <a href="https://support.google.com/outline/answer/15331527" target="_blank" class="absolute block inset-0"></a>
</div>
</p>
    ...
    <a href="../../faq/" class="absolute block inset-0"></a>
                            ...
                            <footer id="retype-content-footer" class="clear-both">
                                ...
                                <nav id="retype-nextprev" class="print:hidden flex mt-14">
                                    <div class="w-1/2">
                                        <a class="px-5 py-4 h-full flex items-center break-normal font-medium text-body-link border border-base-border hover:border-base-border-hover rounded-l-lg transition-colors duration-150 relative hover:z-5" href="../../shadowsocks/windows/">
                                            ...
                                            <span>
                                                ...
                                                <span class="block mt-1">Установка на Windows</span>
                                            </span>
                                        </a>
                                    </div>
                            
                                    <div class="w-1/2">
                                        <a class="px-5 py-4 -mx-px h-full flex items-center justify-end break-normal font-medium text-body-link border border-base-border hover:border-base-border-hover rounded-r-lg transition-colors duration-150 relative hover:z-5" href="../../vless/">
                                            <span>
                                                <span class="block text-xs font-normal text-right text-base-text-muted">Далее</span>
                                                <span class="block mt-1">VPN VLESS</span>
                                            </span>
