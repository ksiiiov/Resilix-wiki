...
<doc-anchor-target id="desktop_computer-установка-vpn-shadowsocks-на-windows" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#desktop_computer-установка-vpn-shadowsocks-на-windows">#</doc-anchor-trigger>
    </h1>
</doc-anchor-target>
<p>В этой инструкции мы расскажем, как установить ShadowSocks VPN. Если вы не знаете, что такое ShadowSocks — не переживайте, это просто один из видов VPN, который является быстрым и безопасным</p>
...
<p>Вам нужен ключ, который выглядит как большая строка со случайными символами и начинается с <code v-pre>ss://</code>. Ключ приходит после оплаты, но его всегда можно заново получить, если есть активная подписка на Buratino VPN</p>
<div class="flex mb-6">
...
<ol start="3">
<li>Нажмите на кнопку «<span class="docs-emoji">&#x1F511;</span> Shadowsocks», далее выберите локацию.</li>
</ol>
<p><figure class="content-center">
...
<p><figure class="content-center">
    <img src="../../screens/влесс/4.PNG" alt="Готовый VLESS ключ" class="rounded-image-rounded border-image-border border-image-border-width" width="400" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
        </div>
...
<doc-anchor-target id="2-скопировать-ключ-доступа">
    <h4>
        ...
        <span>2. <strong>Скопировать ключ доступа</strong></span>
    </h4>
</doc-anchor-target>
<p>Полностью выделите ключ доступа и скопируйте его</p>
<doc-anchor-target id="3-установить-приложение-outline">
    <h4>
        <doc-anchor-trigger class="header-anchor-trigger" to="#3-установить-приложение-outline">#</doc-anchor-trigger>
        <span>3. <strong>Установить приложение Outline</strong></span>
    </h4>
</doc-anchor-target>
<p>
<div class="mb-6 px-5 py-4 flex justify-between relative border border-base-border hover:border-base-border-hover rounded transition-colors duration-150">
    <div class="flex items-center text-base-500">
        ...
        <span class="inline-block font-medium ml-2">Windows</span>
    </div>
    <div class="flex items-center text-xs text-gray-400 dark:text-dark-400">
        <span>https://disk.360.yandex.ru/d/BKCRHiHdkqhUgw</span>
    </div>
    <a href="https://disk.360.yandex.ru/d/BKCRHiHdkqhUgw" target="_blank" class="absolute block inset-0"></a>
</div>
</p>
<doc-anchor-target id="4-открыть-приложение-outline">
    <h4>
        <doc-anchor-trigger class="header-anchor-trigger" to="#4-открыть-приложение-outline">#</doc-anchor-trigger>
        <span>4. <strong>Открыть приложение Outline</strong></span>
    </h4>
</doc-anchor-target>
<p><figure class="content-center">
    <img src="https://okvpn.wiki/static/shadowsocks/0.jpg" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="195" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
...
<p>Нажмите на кнопку «+» в правом верхнем углу</p>
<p><figure class="content-center">
    <img src="https://okvpn.wiki/static/shadowsocks/1.jpg" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="295" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
...
<p>Вставьте скопированный ключ и нажмите на зеленую кнопку «Подтвердить»</p>
<p><figure class="content-center">
    <img src="https://okvpn.wiki/static/shadowsocks/2.jpg" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="295" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
<doc-anchor-target id="6-включить-vpn">
    <h4>
        <doc-anchor-trigger class="header-anchor-trigger" to="#6-включить-vpn">#</doc-anchor-trigger>
        <span>6. <strong>Включить VPN</strong></span>
    </h4>
</doc-anchor-target>
<p>Вы успешно вставили ключ. Нажмите на кнопку «Подключить», чтобы включить VPN. Чтобы отключить — нажмите на кнопку «Отключить»</p>
<p><figure class="content-left">
    <img src="https://okvpn.wiki/static/shadowsocks/3.jpg" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="295" />
    <figcaption class="caption caption-float"></figcaption>
</figure>
<figure class="content-center">
    <img src="https://okvpn.wiki/static/shadowsocks/4.jpg" alt="" class="rounded-image-rounded border-image-border border-image-border-width" width="295" />
    <figcaption class="caption"></figcaption>
</figure>
</p>
    ...
    <a href="../../faq/" class="absolute block inset-0"></a>
                            ...
                            <footer id="retype-content-footer" class="clear-both">
                                ...
                                <nav id="retype-nextprev" class="print:hidden flex mt-14">
                                    <div class="w-1/2">
                                        <a class="px-5 py-4 h-full flex items-center break-normal font-medium text-body-link border border-base-border hover:border-base-border-hover rounded-l-lg transition-colors duration-150 relative hover:z-5" href="../../shadowsocks/macos/">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" overflow="visible"><path d="M19 11H7.41l5.29-5.29a.996.996 0 10-1.41-1.41l-7 7a1 1 0 000 1.42l7 7a1.024 1.024 0 001.42-.01.996.996 0 000-1.41L7.41 13H19c.55 0 1-.45 1-1s-.45-1-1-1z" /><path fill="none" d="M0 0h24v24H0z" /></svg>
                                            <span>
                                                <span class="block text-xs font-normal text-base-text-muted">Назад</span>
                                                <span class="block mt-1">Установка на mac​OS</span>
                                            </span>
                                        </a>
                                    </div>
                            
                                    <div class="w-1/2">
                                        <a class="px-5 py-4 -mx-px h-full flex items-center justify-end break-normal font-medium text-body-link border border-base-border hover:border-base-border-hover rounded-r-lg transition-colors duration-150 relative hover:z-5" href="../../shadowsocks/linux/">
                                            <span>
                                                <span class="block text-xs font-normal text-right text-base-text-muted">Далее</span>
                                                <span class="block mt-1">Установка на Linux</span>
                                            </span>
                        ...
                        <div id="retype-page-footer" class="print:border-none border-t border-base-border pt-6 mb-8">
                            <footer class="flex flex-wrap items-center justify-between print:justify-center">
                                ...
                                <div id="retype-copyright" class="print:justify-center py-2 text-footer-text font-footer-link-weight text-sm leading-relaxed"><p>© Resilix 2025. All rights reserved.</p></div>
                            </footer>
                        </div>
