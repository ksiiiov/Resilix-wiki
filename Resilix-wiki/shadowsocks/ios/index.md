...
<doc-anchor-target id="iphone-установка-vpn-shadowsocks-на-iphone" class="break-words">
    <h1>
        <doc-anchor-trigger class="header-anchor-trigger" to="#iphone-установка-vpn-shadowsocks-на-iphone">#</doc-anchor-trigger>
    </h1>
</doc-anchor-target>
...
<div class="mb-6 px-5 py-4 flex justify-between relative border border-base-border hover:border-base-border-hover rounded transition-colors duration-150">
    <div class="flex items-center text-base-500">
        ...
        <span class="inline-block font-medium ml-2">IOS</span>
    </div>
...
<p>При первом подключении система IOS попросит разрешение для Outline — подтвердите его</p>
